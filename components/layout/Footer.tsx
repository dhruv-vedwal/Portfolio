...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-card/10 py-12 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="flex flex-col gap-3">
            <h4 className="text-xs font-bold tracking-widest uppercase text-primary font-mono">
              Navigation
            </h4>
            <div className="flex flex-col gap-2.5 text-xs text-muted font-mono uppercase tracking-wide">
              <Link href="/" className="hover:text-primary transition-colors">Home Page</Link>
              <Link href="/resume" className="hover:text-primary transition-colors">Timeline</Link>
              <Link href="/systems" className="hover:text-primary transition-colors">Systems Diagram</Link>
              <Link href="/engineering-notes" className="hover:text-primary transition-colors">Engineering Notes</Link>
            </div>
          </div>
